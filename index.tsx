    ...
    return (
        <div className="app">
            ...
            <div className="lfo-container">
                <LFOBar label={parameters.gain.id.toUpperCase()} parameterID={parameters.gain.id} color="#ff0db2"/>
                <LFOBar label={parameters.pan.id.toUpperCase()} parameterID={parameters.pan.id} color="#460dff"/>
            </div>
        </div>
    )
